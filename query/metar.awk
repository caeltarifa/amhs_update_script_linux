...
printf "insert into plan_vuelo_metar_trafico (id_amhs,fecha_llegada,hora_amhs,prioridad,estacion,hora_clima,texto,visto,visto_por) values (\047" $2"\047,\047"datum"\047,\047"$3"\047,\047"$4"\047,\047"$9"\047,\047"$10"\047,\047"; 
